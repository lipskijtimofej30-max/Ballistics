...
namespace Assets.Game.Scripts.Core.Graphics
{
    public class HeightTimeGraphData : IGraphDataSource
    {
        ...
        public HeightTimeGraphData(SimulationRun run)
        {
            ...
            {
                Vector2 p = new Vector2(point.Time, point.Position.y);
                _cachedPoints.Add(p);
